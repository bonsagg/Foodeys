...
public class RecipeResourceBean implements RecipeResource {
    ...
    public Response getRecipeByID(@PathParam("id") long recipeID) {
        ...
        return Response.ok(new RecipeResponse(recipe.getName(), recipe.getInstructions(), ingredientResource.transformIngredientsToIngredientResponses(recipe.getIngredients()))).build();
    }
    ...
    private URI buildURIForRecipe(Recipe recipe) {
